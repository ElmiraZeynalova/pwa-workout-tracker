        ...
        <div className="mobile-layout" style={{ overflowY: 'auto'}} >
            ...
            <main style={{height: 0}}>
                <div className={styles.exercisesListPageContent}>
                    {exercisesList}
                    {(chosenExercises.length > 0 && !isDesktop) && <Button className={styles.addExercisesBtn} handleClick={saveChosenExercises} fill={true}>{chosenExercises.length === 1 ? "Add 1 exercise" : `Add ${chosenExercises.length} exercises`}</Button>}
                </div>
            </main>
        </div>
