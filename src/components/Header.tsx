        ...
        <header>
            ...
            <NavLink className="header-btn" to="/calendar">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="-2 -2 18 18" fill="currentColor">
                    ...
                    <line x1="0" y1="4.2" x2="15" y2="4.2" stroke="black" strokeWidth="1.4"/>

                    <rect x="3.8" y="-0.7" width="1.4" height="2.5" rx="0.6" fill="black"/>
                    <rect x="10.2" y="-0.7" width="1.4" height="2.5" rx="0.6" fill="black"/>
